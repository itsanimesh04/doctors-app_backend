...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'animeshsinghbki2282@gmail.com', // this is the email that will be used to send the email.
        pass: 'rzmo jwbc cvbq zhgi', //this is the password that is created in app passwords in gmail setting options.
    },
});
...
resendOtp = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            from: 'animeshsinghbki2282@gmail.com',
            to: email,
